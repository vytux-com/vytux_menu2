		...
		<table class="table table-bordered table-condensed">
			<thead>
				<tr>
					...
					<th class="col-sm-4"><?php echo WT_I18N::translate('Menu title'); ?></th>
					<th class="col-sm-4"><?php echo WT_I18N::translate('Menu address'); ?></th>
					<th class="col-sm-2" colspan=4><?php echo WT_I18N::translate('Controls'); ?></th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					...
					<td>
						<?php echo WT_Filter::escapeHtml(WT_I18N::translate($item->menu_title)); ?>
					</td>
					<td>
						<?php echo WT_Filter::escapeHtml(substr(WT_I18N::translate($item->menu_address), 0, 1)=='<' ? WT_I18N::translate($item->menu_address) : nl2br(WT_I18N::translate($item->menu_address))); ?>
					</td>
					...
					<td class="text-center">
						<a href="module.php?mod=<?php echo $this->getName(); ?>&amp;mod_action=admin_delete&amp;block_id=<?php echo $item->block_id; ?>"
							onclick="return confirm('<?php echo WT_I18N::translate('Are you sure you want to delete this menu?'); ?>');">
